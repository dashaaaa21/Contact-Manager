...
import { editStatus } from '../../redux/contactsSlice';
...
export default function EditContactStatus() {
    ...
    const { statusName } = useParams<{ statusName: string }>();
    ...
    const handleSubmit = (values: FormValues) => {
        ...
        dispatch(editStatus({ oldStatus: statusName, newStatus: values.statusName.toLowerCase(), newBg: values.bg }));
